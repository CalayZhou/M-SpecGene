_base_ = [
    ...
    '../_base_/default_runtime.py', '../_base_/schedules/schedule_320k.py'#160k
]
...
model = dict(
    ...
    #pretrained = './pretrain/0930_vit-s_v9.1_54w_bs1024_epoch_500_mmseg_transform.pth',    
    pretrained='./pretrain/1006_vit-b_v9.2_54w_bs1024_decode4_epoch_500_mmseg_transform.pth', 
    backbone=dict(
        type='MAE',
