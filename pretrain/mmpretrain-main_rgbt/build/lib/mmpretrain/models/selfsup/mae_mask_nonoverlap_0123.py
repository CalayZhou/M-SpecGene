...
class MAEViT(VisionTransformer):
    ...
    def random_masking(
        ...
        #calay 0122
        if ids_shuffle_pre is not None:
            ids_shuffle = torch.flip(ids_shuffle_pre,dims=[1])
        else:
    ...
    def forward(
        ...
        if mask is None or False:
            ...
            x, mask, ids_restore,ids_shuffle = self.random_masking(x, ids_restore_pre, ids_shuffle_pre, self.mask_ratio)
