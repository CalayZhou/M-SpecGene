...
class MAEViT(VisionTransformer):
    ...
    def random_masking(
        ...
        noise_ori = torch.randn(N, L, device=x.device)*0.1+self.noisebias #+bias#-1#+0.9#0~1noise = {Tensor: (12, 196)} tensor([[0.2584, 0.8953, 0.4121,  ..., 0.9540, 0.3227, 0.5171],\n        [0.2006, 0.6923, 0.4589,  ..., 0.4050, 0.5022, 0.0339],\n        [0.2504, 0.4164, 0.3633,  ..., 0.8755, 0.5532, 0.2289],\n        ...,\n        [0.2844, 0.8122, 0.6207,  ..., 0.6554, 0.29... View
        ...
        ids_shuffle,cos_sim2 = self.cal_ids_shuffle(noise, cos_sim, cos_sim2, x, len_keep1,first_modality=True)
        ...
        noise2_ori = torch.randn(N, L, device=x.device)*0.1+self.noisebias #+bias#-1#+0.9#0~1noise = {Tensor: (12, 196)} tensor([[0.2584, 0.8953, 0.4121,  ..., 0.9540, 0.3227, 0.5171],\n        [0.2006, 0.6923, 0.4589,  ..., 0.4050, 0.5022, 0.0339],\n        [0.2504, 0.4164, 0.3633,  ..., 0.8755, 0.5532, 0.2289],\n        ...,\n        [0.2844, 0.8122, 0.6207,  ..., 0.6554, 0.29... View
        ...
        len_keep2 = len_keep+9
        noise2 = noise2_ori * (cos_sim_max-cos_sim_min).unsqueeze(1)+cos_sim_min.unsqueeze(1)
        ids_shuffle2  = self.cal_ids_shuffle(noise2, cos_sim2, cos_sim2, x, len_keep2, first_modality=False)
        ...
        if self.count>700:
            ...
            self.noisebias = 0.01*self.epoch
