...
from .GMM_CMSS_SAMPLE import GMM_CMSS_SAMPLE
...
class MAEViT(VisionTransformer):
    ...
    def __init__(self,
        ...
        self.epoch = 0
        self.noisebias = 0.0
        self.GMM_CMSS_SAMPLE = GMM_CMSS_SAMPLE()
    ...
    def random_masking(
        ...
        x_masked, mask, ids_restore, \
            x_masked2, mask2, ids_restore2 = self.GMM_CMSS_SAMPLE.sample(x,x2,loss1,loss2,mask_ratio)
    ...
    def forward(
        ...
        if mask is None or False:
            ...
            x, mask, ids_restore,\
                ...
                = self.random_masking(x, x2, loss1, loss2, self.mask_ratio)
...
class MAE(BaseSelfSupervisor):
    ...
    def loss(self, inputs: torch.Tensor, data_samples: List[DataSample],
        ...
        latent, mask, ids_restore, latent2, mask2, ids_restore2\
            = self.backbone(input_rgb, input_ir,self.loss1,self.loss2)#64 3 224 224
